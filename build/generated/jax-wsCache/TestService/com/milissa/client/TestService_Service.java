 ...
 * 
 */
@WebServiceClient(name = "TestService", targetNamespace = "http://ws.milissa.com/", wsdlLocation = "http://localhost:8081/TesteWS/TestService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTSERVICE_QNAME = new QName("http://ws.milissa.com/", "TestService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/TesteWS/TestService?wsdl");
    ...
    public TestService getTestServicePort() {
        return super.getPort(new QName("http://ws.milissa.com/", "TestServicePort"), TestService.class);
    }
    ...
    public TestService getTestServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.milissa.com/", "TestServicePort"), TestService.class, features);
    }
